...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset_root", type=str, default="/home/marcis/moss_tts_lv_model/data/output_dataset")
...
def main() -> None:
    ...
    for index, record in enumerate(records):
        ...
        # TODO only this time add args.dataset_root to audio path
        audio_path = f"{args.dataset_root}/{audio_path}"
